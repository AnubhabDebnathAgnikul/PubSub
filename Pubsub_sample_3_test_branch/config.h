...
#define SHM_NAME_SUB "/shared_mem_8051" // Name of the SHM the Subscriber process should read message from 
#define PORT_CHECK_SUB "8031" // Port check parameter (check for matching by tokenizing the Disc. Message)